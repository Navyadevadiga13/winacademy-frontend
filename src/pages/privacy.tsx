  ...
  return (
    ...
    >
      ...
      >
        ...
        <p><strong>Last updated on Sep 9th 2025</strong></p>

        <p>
          For the purpose of these Terms and Conditions, the terms <strong>"we"</strong>, <strong>"us"</strong>, <strong>"our"</strong> used anywhere on this page shall mean EDUWIN SERVICES PRIVATE LIMITED, whose registered/operational office is 1st Floor, Inland Ornate, Kodiyalbail, Dakshina Kannada, Mangalore, Karnataka, India 575003 Kodiyalbail KARNATAKA 575003. The terms <strong>"you"</strong>, <strong>“your”</strong>, <strong>"user"</strong>, <strong>“visitor”</strong> shall mean any natural or legal person who is visiting our website and/or agreed to purchase from us.
        </p>
        ...
        >
          ...
          <li>
            You may not create a link to our website from another website or document without EDUWIN SERVICES PRIVATE LIMITED’s prior written consent.
          </li>
          <li>
        ...
        <p className="fw-bold text-center" style={{ color: "#444" }}>
          Disclaimer: The above content is created at EDUWIN SERVICES PRIVATE LIMITED's sole discretion. Razorpay shall not be liable for any content provided here and shall not be responsible for any claims and liability that may arise due to merchant’s non-adherence to it.
        </p>
        ...
        >
          <li>
            EDUWIN SERVICES PRIVATE LIMITED believes in helping its customers as far as possible, and has therefore a liberal cancellation policy. Under this policy:
          </li>
          <li>
          ...
          <li>
            EDUWIN SERVICES PRIVATE LIMITED does not accept cancellation requests for perishable items like flowers, eatables etc. However, refund/replacement can be made if the customer establishes that the quality of product delivered is not good.
          </li>
          <li>
          ...
          <li>
            In case of any Refunds approved by the EDUWIN SERVICES PRIVATE LIMITED, it’ll take 3-5 days for the refund to be processed to the end customer.
          </li>
        </ul>
        ...
        <h2 className="text-center mb-4">Shipping & Delivery Policy</h2>

        <p><strong>Last updated on Sep 9th 2025</strong></p>

        <p>
          For International buyers, orders are shipped and delivered through registered international courier companies and/or International speed post only. For domestic buyers, orders are shipped through registered domestic courier companies and /or speed post only. Orders are shipped within 0-7 days or as per the delivery date agreed at the time of order confirmation and delivering of the shipment subject to Courier Company / post office norms. EDUWIN SERVICES PRIVATE LIMITED is not liable for any delay in delivery by the courier company / postal authorities and only guarantees to hand over the consignment to the courier company or postal authorities within 0-7 days rom the date of the order and payment or as per the delivery date agreed at the time of order confirmation. Delivery of all orders will be to the address provided by the buyer. Delivery of our services will be confirmed on your mail ID as specified during registration. For any issues in utilizing our services you may contact our helpdesk on 8169602909 or <a href="mailto:wizdom.edge@gmail.com" className="text-primary">wizdom.edge@gmail.com</a>
        </p>
